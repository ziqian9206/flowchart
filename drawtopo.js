...
(function() {
	...
	jsPlumb.importDefaults({
		//https://jsplumbtoolkit.com/community/apidocs/classes/Endpoint.html endpoint
		DragOptions : { cursor: 'pointer', zIndex:2000 },
	
		EndpointStyles : [{ fillStyle:'#225588' }, { fillStyle:'#558822' }],
	
		Endpoints : [ "Dot", { radius:2 } ],
	...
	window.topoDrawUtil = {
		...
		targetEndpoint: {
			...
			isTarget:true,			
	        overlays:[
	        	[ "Arrow", { location:1, width:20,label:"", cssClass:"endpointTargetLabel" } ]
	        ]
		},
